...
#args = parse_args()
args = {'output_dir': '/tmp', 'base_model_path': "booksforcharlie/stable-diffusion-inpainting", "resume_path": "zhengchong/CatVTON", "mixed_precision": "fp16", "repaint": True, "height": 1024, "width": 768, "allow_tf32": True}
